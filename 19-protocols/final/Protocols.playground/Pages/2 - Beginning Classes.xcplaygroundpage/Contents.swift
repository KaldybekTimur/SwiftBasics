...
var accoutType : Account.Type = BitcoinAccount.self
let account = accoutType.init(initialAmount: 30.00)
let transferAcc = accoutType.init(transferAccount: account)
...
let aa = rr(wins: 5, loses: 5)
let bb = rr(wins: 5, loses: 5)

// aa == bb  - Binary operator '==' cannot be applied to two 'rr' operands

protocol Equatable {
static func ==(lhs: Self, rhs: Self) -> Bool
}
extension rr : Equatable{
    static func == (lhs: rr, rhs: rr) -> Bool {
